-- B1A MERGE FUNCTION FINAL FIX
-- Handle JSONB array type for ingredients_tokens
        ...
        IF EXISTS (
            ...
            SET 
                ...
                ingredients_tokens = CASE 
                    WHEN ingredients_tokens IS NULL OR ingredients_tokens = '[]'::jsonb
                    THEN to_jsonb(rec.ingredients_tokens)
            ...
            ELSE
                ...
                IF EXISTS (
                    ...
                    INSERT INTO foods_canonical (
                        ...
                        rec.ingredients_raw,
                        to_jsonb(rec.ingredients_tokens),  -- Convert array to JSONB
